    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-16 lg:h-20">
        ...
        <div className="hidden lg:flex items-center gap-1">
          ...
          <Link
            href={ctaHref}
            className="ml-4 inline-flex items-center h-10 px-6 rounded-full bg-accent text-white type-body-sm font-display font-medium hover:bg-gold-500 transition-colors duration-200"
          >
            {ctaLabel}
          </Link>
        </div>
